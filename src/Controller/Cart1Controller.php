...
/**
 * @Route("/cart1", name="cart1_")
 */
class Cart1Controller extends AbstractController
{
    /**
     * @Route("/", name="index")
     */
    public function index(SessionInterface $session, ProductsRepository $productsRepository)
    {
        ...
        return $this->render('cart1/index.html.twig', compact("dataPanier", "total"));
    ...
    public function add(Products $product, SessionInterface $session)
    {
        ...
        return $this->redirectToRoute("cart1_index");
    }
